...
function opensubject1(){
	emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'subjectxx.php?slid=&view=', 'Insert Subject', 'width=550px,height=450px,center=1,resize=0,scrolling=1')

...
<table width="371" border="1">
  <tr>
    <th width="46" scope="col">ID</td>
    <th width="88" scope="col">Name</td>
    <th width="87" scope="col">Date of birth</td>
    <th width="57" scope="col">Course</td>
    <th width="59" scope="col">Semester</td>
  </tr>
  <?php

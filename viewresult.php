...
<h1><a href="viewresult.php">Student Registration No.</a></h1>
</header>
<form name="form1" method="post" action="result.php">
  <table>
    <tr><td><label for="textfield2">Roll No</label></td>
    <td><input type="text" name="rollno" id="textfield2" placeholder="eg.12345"></td></tr> <tr><td> </td>
    <td><input type="submit" name="button2" id="button2" value="Submit"></td></tr>
 </table>
</form>
<hr />
</article>

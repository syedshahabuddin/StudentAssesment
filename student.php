...
if(mysql_num_rows($result) >= 1)
{
    ...
    <table width="500" border="1">
      <tr>
        <th width="38" scope="col"><strong>SL No.</strong></td>
        <th width="73" scope="col"><strong>ID</strong></td>
        <th width="50" scope="col"><strong>Name</strong></td>
        <th width="56" scope="col"><strong>Phone</strong></td>
           <?php
      if($_SESSION["type"]=="admin")
	{
		?>
        <th width="119" scope="col"><strong>Action</strong></td>
          <?php
	}
	?>
        </tr>
...
$i =$_GET["first"]+1;
  ...
  echo "<td>&nbsp;" . $row['studfname'] . " " . $row['studlname'] . "</td>";
      ...
      if($_SESSION["type"]=="admin")
	{
	      ...
	      echo "<td>&nbsp;<a href='viewrecords.php?slid=<?php echo $row[courseid]; ?>&view=studentdetails'><img src='images/view.png' width='32' height='32' /></a>
		   <a href='studentins.php?slid=$row[studid]&view=studentdetails'>  <img src='images/edit.png' width='32' height='32' /></a>";
		   ?>
           
 <a href='student.php?slid=<?php echo $row[studid]; ?>&view=delete'><img src='images/delete.png' width='32' height='32' onclick="return confirm('Are you sure??')"/></a></td>
	<?php
    }
  echo "</tr>&nbsp;";
 $i++;

...
?>
<table width="1000" style="color: #000000;"  border="1">
...
while($rowabb = mysql_fetch_array($ressubb))
  {
    echo "<td><input type='text' name='subidd[]' id='subidd[]' size='5' onblur='javascript:return submit_form(this);' ></td>";
}
...
<br>
<table width="1000" style="color: #000000;" border="0">
  <?php
 ...
 while($rowa = mysql_fetch_array($restotstrec))
  ...
  <tr align="center">
    <td height="30" colspan="5"><input type="submit" name="exambutton" id="button" value="Insert Records">
      <input type="reset" id="button2" value="Reset"></td>
  </tr>
</table>
